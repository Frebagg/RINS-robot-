...
def generate_launch_description():
    ...
    top_camera_bridge = Node(
        package='ros_gz_bridge',
        executable='parameter_bridge',
        name='top_camera_bridge',
        output='screen',
        parameters=[{'use_sim_time': use_sim_time}],
        arguments=[
            ['/world/', world,
             '/model/', robot_name,
             '/link/top_camera_rgb_camera_frame/sensor/rgbd_camera/image' +
             '@sensor_msgs/msg/Image' +
             '[gz.msgs.Image'],
            ['/world/', world,
             '/model/', robot_name,
             '/link/top_camera_rgb_camera_frame/sensor/rgbd_camera/depth_image' +
             '@sensor_msgs/msg/Image' +
             '[gz.msgs.Image'],
            ['/world/', world,
             '/model/', robot_name,
             '/link/top_camera_rgb_camera_frame/sensor/rgbd_camera/points' +
             '@sensor_msgs/msg/PointCloud2' +
             '[gz.msgs.PointCloudPacked'],
            ['/world/', world,
             '/model/', robot_name,
             '/link/top_camera_rgb_camera_frame/sensor/rgbd_camera/camera_info' +
             '@sensor_msgs/msg/CameraInfo' +
             '[gz.msgs.CameraInfo'],
            ],
        remappings=[
    ...
    ld.add_action(top_camera_bridge)
    return ld
