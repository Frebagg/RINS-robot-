...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('map', default_value=PathJoinSubstitution([pkg_rins_robot, 'maps', 'task2.yaml']), description='Full path to map yaml file to load')
]
...
def generate_launch_description():    
    ...
    localization_launch = PathJoinSubstitution([pkg_rins_robot, 'launch', 'localization.launch.py'])
    nav2_launch = PathJoinSubstitution([pkg_rins_robot, 'launch', 'nav2.launch.py'])
